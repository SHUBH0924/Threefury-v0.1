...
<ul className="navbar-nav ms-auto cursorSet">
    ...
    <li>
    <button type="button" onClick={() => window.location.replace("/#modal-contact-form-data")} className="btn btn-hover-1-copy color-1" href="12"><span>Get a Quote</span></button></li>  </ul>
</div>
</div>
</nav>
</div>
